...
function showSelectedOperator(){
    ...
    if (operator_value == "+"){
        document.getElementById("plus").style.backgroundColor  = "#ffd11a";
    }
    else if (operator_value == "-"){
        document.getElementById("sub").style.backgroundColor  = "#ffd11a";
    }
    else if (operator_value == "*"){
        document.getElementById("mult").style.backgroundColor  = "#ffd11a";
    }
    else if (operator_value == "/"){
        document.getElementById("div").style.backgroundColor  = "#ffd11a";
    }
}
